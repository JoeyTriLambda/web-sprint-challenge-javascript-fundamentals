...
// Nested function can access the variable internal because it is a child child function of the function myFunction.
// Because myFunction is the Parent function all child functions nested in it can access variables and other parameters inside the parent function.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(zooAnimals){
    const pop = []
    zooAnimals.forEach(i => pop.push(i['population']))
    const reducer = (acc, currValue) => acc + currValue;
    let USApop1 = pop.reduce(reducer)
    return USApop1
  }
